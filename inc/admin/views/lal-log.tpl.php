...
<form method="get">
	<input type="hidden" name="page" value="plc_lal_log_show" />
	...
	<?php foreach (array("recent", "message", "username", "ip") as $item): ?>
...
<table id="login-table">
	<tr>
		...
		<?php endif; ?>
		<th id="lal-lt-username">E-mail/Username</th>
		<th id="lal-lt-message">Message</th>
...
<?php foreach ($log as $item): ?>
	<tr>
		...
		<td class="lal-li-message"><?=htmlspecialchars($item->password)?></td>
